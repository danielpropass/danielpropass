...
- Remote desktop support (Windows, macOS)
- Network configuration & troubleshooting (DHCP, DNS, IP addressing)
- Windows Server, Active Directory & Microsoft 365 administration
- Virtual device administration (Azure, AWS, VMware)
- Helpdesk ticketing systems in MSP-style environments
